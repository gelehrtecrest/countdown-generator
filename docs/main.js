(function($){
	...
	const font_eorzea_smart = "/1.5 'EorzeaSmart','ヒラギノ明朝 ProN','Hiragino Mincho ProN','Sawarabi Mincho','Noto Serif CJK JP','MS PMincho',serif";
	...
	const font_thavnair = "/1.5 'Thavnair','ヒラギノ明朝 ProN','Hiragino Mincho ProN','Sawarabi Mincho','Noto Serif CJK JP','MS PMincho',serif";
...
*/
		...
		$('.font_button').click(function(e) {
			...
			} else if(id == "font_eorzea_smart"){
				$('#font').val(font_eorzea_smart);
			...
			} else if(id == "font_thavnair"){
				$('#font').val(font_thavnair);
		...
		$('.font_buttonB').click(function(e) {
			...
			} else if(id == "font_eorzea_smartB"){
				$('#fontB').val(font_eorzea_smart);
			...
			} else if(id == "font_eorzea_squareB"){
			...
			} else if(id == "font_thavnairB"){
				$('#fontB').val(font_thavnair);
		...
		$('.font_buttonC').click(function(e) {
			...
			} else if(id == "font_eorzea_smartC"){
				$('#fontC').val(font_eorzea_smart);
			...
			} else if(id == "font_eorzea_squareC"){
			...
			} else if(id == "font_thavnairC"){
				$('#fontC').val(font_thavnair);
