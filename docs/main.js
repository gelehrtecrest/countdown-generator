(function($){
	...
	WebFont.load({
		custom: {
			families: ['Norvrandt','Kugane', '@Kugane','NieR','Eorzea', 'Allagan', 'Near-Eastern', 'Eden', 'Eorzea-Blackletter','TrainOne','Stick','RocknRollOne','ReggaeOne','RampartOne','KleeOne','KleeOne-SemiBold','DotGothic16','EorzeaDot','KuganeDot','NorvrandtDot'],
			urls: ['style.css']
		},
		loading: function() {
			console.log('loading');
